...
class RiverpodVersionPage extends StatelessWidget {
  const RiverpodVersionPage({Key? key, required this.title}) : super(key: key);
...
class _BodyState extends ConsumerState<Body> {
  ...
  void initState() {
    SchedulerBinding.instance
        ?.addPostFrameCallback((_) => controller.state.initShapeOnTop());
...
class Block extends StatelessWidget {
  ...
  final StateProvider<BlockColor> blockColor;
